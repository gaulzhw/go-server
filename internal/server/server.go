...
import (
	...
	"github.com/gaulzhw/go-server/internal/pkg/middleware"
	"github.com/gaulzhw/go-server/internal/server/store/mysql"
	"github.com/gaulzhw/go-server/pkg/token"
	"github.com/gaulzhw/go-server/pkg/util/homedir"
	"github.com/gaulzhw/go-server/pkg/version/verflag"
)

const (
	// recommendedHomeDir defines the default directory used to place all server service configurations.
	recommendedHomeDir = ".server"

	// defaultConfigName specify the default configuration file for server.
	defaultConfigName = "server.yaml"

	// appName defines the executable binary filename for server component.
	appName = "server"
)
...
func NewServerCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   appName,
		Short: "A practical project",
		Long:  `A practical project, used to create user with basic information.`,
	...
	// Add --version flag to server command line
